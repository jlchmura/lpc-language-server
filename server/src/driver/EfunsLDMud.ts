...
efun("cos", LpcTypes.floatType, false, ["arg", LpcTypes.intType]);
...
efun("db_affected_rows", LpcTypes.intType, true, ["handle", LpcTypes.intType]);
efun("db_connect", LpcTypes.intType, true, ["database", LpcTypes.stringType], ["user", LpcTypes.stringType], ["password", LpcTypes.stringType]);
efun("db_close", LpcTypes.intType, true, ["handle", LpcTypes.intType]);
efun("db_error", LpcTypes.stringType, true, ["handle", LpcTypes.intType]);
efun("db_conv_string", LpcTypes.stringType, false, ["str", LpcTypes.stringType]);
efun("db_exec", LpcTypes.intType, true, ["handle", LpcTypes.intType], ["statement", LpcTypes.stringType]);
...
efun("slice_array", LpcTypes.mixedArrayType, true, ["arr", LpcTypes.mixedArrayType], ["from", LpcTypes.intType], ["to", LpcTypes.intType]);
...
efun("sqrt", LpcTypes.floatType, false, ["arg", LpcTypes.intType]);
