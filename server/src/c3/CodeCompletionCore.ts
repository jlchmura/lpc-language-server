...
// import { Parser, Token, TokenStream, ParserRuleContext, IntervalSet, ATNState, ATN, RuleStopState ,ATNDeserializer} from "antlr4";
...
//         this.parser = parser;
//         this.atn = (parser as any).getATNWithBypassAlts();
//         this.vocabulary = parser.;
...
//         const tokenStream: TokenStream = this.parser.getTokenStream();
