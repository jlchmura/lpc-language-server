...
export class LPCParser extends antlr.Parser {
    ...
    public methodInvocation(): MethodInvocationContext {
        ...
        try {
            ...
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            if ((((_la) & ~0x1F) === 0 && ((1 << _la) & 148897900) !== 0) || ((((_la - 35)) & ~0x1F) === 0 && ((1 << (_la - 35)) & 2013270049) !== 0) || ((((_la - 68)) & ~0x1F) === 0 && ((1 << (_la - 68)) & 25603) !== 0) || ((((_la - 105)) & ~0x1F) === 0 && ((1 << (_la - 105)) & 978437) !== 0)) {
                {
                this.state = 503;
                this.argumentList();
                }
    ...
    public static readonly _serializedATN: number[] = [
        ...
        40,47,47,1,0,53,57,2,0,118,118,124,124,2,0,52,58,60,61,2,0,52,56,
        58,60,2,0,7,7,41,41,11,0,2,3,6,6,8,8,18,18,22,22,30,30,32,34,36,
        36,39,39,42,43,49,49,1,0,92,104,4,0,63,65,68,69,78,78,81,82,1,0,
        65,67,1,0,63,64,1,0,70,71,1,0,72,75,2,0,27,27,76,77,2,0,91,91,106,
        106,2,0,35,35,122,123,7,0,2,3,6,6,21,21,27,27,40,40,47,47,124,124,
        2,0,38,38,51,51,6,0,63,67,70,81,83,85,88,88,92,102,111,111,2,0,109,
        109,111,111,1,0,63,66,4,0,114,114,116,116,118,119,124,124,2,0,27,
        27,86,86,2,0,114,116,119,119,1301,0,175,1,0,0,0,2,196,1,0,0,0,4,
        198,1,0,0,0,6,202,1,0,0,0,8,217,1,0,0,0,10,219,1,0,0,0,12,221,1,
        0,0,0,14,223,1,0,0,0,16,250,1,0,0,0,18,256,1,0,0,0,20,268,1,0,0,
        0,22,270,1,0,0,0,24,281,1,0,0,0,26,283,1,0,0,0,28,285,1,0,0,0,30,
        304,1,0,0,0,32,306,1,0,0,0,34,330,1,0,0,0,36,348,1,0,0,0,38,350,
        1,0,0,0,40,353,1,0,0,0,42,362,1,0,0,0,44,375,1,0,0,0,46,383,1,0,
        0,0,48,385,1,0,0,0,50,390,1,0,0,0,52,403,1,0,0,0,54,406,1,0,0,0,
        56,418,1,0,0,0,58,421,1,0,0,0,60,432,1,0,0,0,62,440,1,0,0,0,64,442,
        1,0,0,0,66,444,1,0,0,0,68,462,1,0,0,0,70,468,1,0,0,0,72,485,1,0,
        0,0,74,491,1,0,0,0,76,498,1,0,0,0,78,500,1,0,0,0,80,502,1,0,0,0,
        82,508,1,0,0,0,84,513,1,0,0,0,86,550,1,0,0,0,88,552,1,0,0,0,90,570,
        1,0,0,0,92,606,1,0,0,0,94,608,1,0,0,0,96,612,1,0,0,0,98,614,1,0,
        0,0,100,622,1,0,0,0,102,673,1,0,0,0,104,766,1,0,0,0,106,768,1,0,
        0,0,108,791,1,0,0,0,110,828,1,0,0,0,112,856,1,0,0,0,114,871,1,0,
        0,0,116,892,1,0,0,0,118,920,1,0,0,0,120,922,1,0,0,0,122,941,1,0,
        0,0,124,943,1,0,0,0,126,954,1,0,0,0,128,956,1,0,0,0,130,963,1,0,
        0,0,132,966,1,0,0,0,134,972,1,0,0,0,136,982,1,0,0,0,138,996,1,0,
        0,0,140,1017,1,0,0,0,142,1027,1,0,0,0,144,1029,1,0,0,0,146,1038,
