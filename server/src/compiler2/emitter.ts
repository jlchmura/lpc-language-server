...
import { cast, contains, createGetCanonicalFileName, emptyArray, every, filter, findIndex, firstOrUndefined, forEach, GetCanonicalFileName, isArray, last, lastOrUndefined, length, memoize, some, stableSort, tryCast } from "./core";
import { Comparison } from "./corePublic";
import { Debug } from "./debug";
import { getIdentifierTypeArguments } from "./factory/emitNode";
import { factory, setOriginalNode } from "./nodeFactory";
import { isSourceFile, isIdentifier, isStringLiteral, isTypeParameterDeclaration, isNumericLiteral, isBlock, isBinaryExpression, isParenthesizedExpression, isDecorator, isArrowFunction, isPrivateIdentifier } from "./nodeTests";
import { forEachChild } from "./parser";
import { combinePaths, comparePaths, directorySeparator, ensureTrailingDirectorySeparator, fileExtensionIs, fileExtensionIsOneOf, getBaseFileName, getDirectoryPath, getNormalizedAbsolutePath, getRelativePathFromDirectory, getRelativePathToDirectoryOrUrl, getRootLength, normalizePath, normalizeSlashes, resolvePath } from "./paths";
import { getLineStarts, tokenToString, skipTrivia, getLineAndCharacterOfPosition, computeLineStarts } from "./scanner";
import { tracing } from "./tracing";
import { ArrayBindingPattern, ArrayLiteralExpression, ArrayTypeNode, ArrowFunction, BinaryExpression, BinaryOperatorToken, BindingElement, BindingPattern, Block, BuildInfo, CallExpression, CallSignatureDeclaration, CaseBlock, CaseClause, CaseOrDefaultClause, CatchClause, CommaListExpression, CompilerOptions, ComputedPropertyName, ConditionalExpression, ConditionalTypeNode, ConstructorTypeNode, DeclarationName, DefaultClause, DoStatement, DotToken, ElementAccessExpression, EmitFlags, EmitOnly, EmitResolver, EmitResult, EmitTextWriter, EntityName, Expression, ExpressionStatement, ExpressionWithTypeArguments, FileReference, ForInStatement, ForStatement, FunctionDeclaration, FunctionExpression, FunctionLikeDeclaration, FunctionTypeNode, GeneratedIdentifier, GeneratedIdentifierFlags, GeneratedNamePart, GeneratedPrivateIdentifier, HasLocals, HeritageClause, Identifier, IfStatement, ImportClause, ImportDeclaration, ImportSpecifier, ImportTypeNode, IndexedAccessTypeNode, IndexSignatureDeclaration, InferTypeNode, InterfaceDeclaration, JSDoc, JSDocComment, JSDocFunctionType, JSDocImportTag, JSDocPropertyLikeTag, JSDocReturnTag, JSDocSignature, JSDocTag, JSDocTemplateTag, JSDocTypeExpression, JSDocTypeLiteral, JSDocTypeTag, JsxAttributes, LateBoundDeclaration, LiteralExpression, LiteralLikeNode, LiteralTypeNode, MappedTypeNode, MethodDeclaration, MethodSignature, Modifier, ModifierLike, NamedDeclaration, NamedImports, NamedTupleMember, NewExpression, Node, NodeArray, NodeFlags, NonNullExpression, NumericLiteral, ObjectBindingPattern, ObjectLiteralExpression, OptionalTypeNode, ParameterDeclaration, ParenthesizedExpression, ParenthesizedTypeNode, PostfixUnaryExpression, PrefixUnaryExpression, PrivateIdentifier, PropertyAccessExpression, PropertyAssignment, PropertyDeclaration, PropertySignature, QualifiedName, ReturnStatement, ShorthandPropertyAssignment, SignatureDeclaration, SourceFile, SpreadAssignment, SpreadElement, Statement, StringLiteral, SwitchStatement, SymbolFlags, SyntaxKind, TaggedTemplateExpression, TextRange, TokenFlags, TupleTypeNode, TypeAliasDeclaration, TypeAssertion, TypeLiteralNode, TypeNode, TypeOperatorNode, TypeParameterDeclaration, TypeReferenceNode, UnionTypeNode, VariableDeclaration, VariableDeclarationList, VariableStatement, VoidExpression, WhileStatement, WriteFileCallbackData } from "./types";
import { createDiagnosticCollection, createTextWriter, isKeyword, getEmitFlags, setTextRangePosEnd, isAccessExpression, createBinaryExpressionTrampoline, nodeIsSynthesized, positionIsSynthesized, getSourceFileOfNode, getSourceTextOfNodeFromSourceFile, formatGeneratedNamePart, isNodeDescendantOf, formatGeneratedName } from "./utilities";
import { isExpression, skipPartiallyEmittedExpressions, getParseTreeNode, setTextRange, isModifier, isFunctionLike, isGeneratedIdentifier, isMemberName, idText, isBindingPattern, canHaveLocals, escapeLeadingUnderscores } from "./utilitiesPublic";
