...
export function getEffectiveTypeAnnotationNode(node: Node): TypeNode | undefined {
    ...
    if (isObjectOrMixedType(type) || (isArrayTypeNode(type) && isObjectOrMixedType(type.elementType))) {
