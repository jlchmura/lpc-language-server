import { append, CompilerOptions, Debug, DiagnosticWithLocation, disposeEmitNodes, EmitFlags, EmitHelper, EmitHint, EmitHost, EmitResolver, factory, FunctionDeclaration, getEmitFlags, getParseTreeNode, getSourceFileOfNode, Identifier, isSourceFile, LexicalEnvironmentFlags, memoize, Node, NodeFactory, NodeFlags, noop, notImplemented, performance, returnUndefined, setEmitFlags, some, SourceFile, Statement, SyntaxKind, tracing, TransformationContext, TransformationResult, TransformerFactory, VariableDeclaration } from "./_namespaces/lpc";
