...
export function createCompilerHostWorker(
    ...
    function tryGetLocalizedLibPath(options: CompilerOptions): string {
        const basePath = getDefaultLibLocation();
