...
import { combinePaths } from "./paths";
import { Type, ObjectFlags, TypeFlags, IndexedAccessType, TypeReference, ConditionalType, SubstitutionType, ReverseMappedType, EvolvingArrayType, UnionType, IntersectionType, IndexType, Path, Node, LineAndCharacter } from "./types";
    ...
    function dumpTypes(types: readonly Type[]) {
        ...
        for (let i = 0; i < numTypes; i++) {
            ...
            const descriptor = {
                ...
                symbolName: symbol?.name && unescapeLeadingUnderscores(symbol.name),
