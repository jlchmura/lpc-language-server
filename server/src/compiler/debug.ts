...
export namespace Debug {
    ...
    export function formatObjectFlags(flags: ObjectFlags | undefined): string {
        return formatEnum(flags, (__types as any).ObjectFlags, /*isFlags*/ true);
    }

    export function formatSignatureFlags(flags: SignatureFlags | undefined): string {
        return formatEnum(flags, (__types as any).SignatureFlags, /*isFlags*/ true);
    }
    
    export function formatTypeFlags(flags: TypeFlags | undefined): string {
        return formatEnum(flags, (__types as any).TypeFlags, /*isFlags*/ true);
    }
    ...
    export function formatNodeFlags(flags: NodeFlags | undefined): string {
        return formatEnum(flags, (__types as any).NodeFlags, /*isFlags*/ true);
    }

    export function formatModifierFlags(flags: ModifierFlags | undefined): string {
        return formatEnum(flags, (__types as any).ModifierFlags, /*isFlags*/ true);
    }
    ...
    export function formatSymbolFlags(flags: SymbolFlags | undefined): string {
        return formatEnum(flags, (__types as any).SymbolFlags, /*isFlags*/ true);
    }
