...
export namespace LpcParser {
    ...
    function parseDeclaration(): Statement {
        ...
        if (token() == SyntaxKind.StructKeyword) {
            if (lookAhead(() => nextToken() === SyntaxKind.Identifier && nextToken() !== SyntaxKind.Identifier)) {                
