...
export namespace LpcParser {
    ...
    function parseParameterWorker(allowAmbiguity = true): ParameterDeclaration | undefined {
        ...
        const paramType = inContext(NodeFlags.DisallowTypes) ? undefined : parseType();
