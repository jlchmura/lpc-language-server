...
export namespace LpcParser {
    ...
    function parseNewStructExpression(): NewStructExpression {
        ...
        const args = parseDelimitedList(ParsingContext.ArgumentExpressions, parseArgumentExpression);
