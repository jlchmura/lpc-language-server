#define ASSERT_EQ(x,y) if((mixed)x != (mixed)y) { write("error"); }

// Adapted from https://raw.githubusercontent.com/fluffos/fluffos/refs/heads/master/testsuite/single/tests/compiler/utf8.c
